...
for f in ['references/visual-diagnosis.md','references/obstruction-removal.md','references/medium-selection.md','references/prompt-compiler.md','references/quality-gate.md','references/motion-design.md','references/recipes/portal-woodcut.md','references/recipes/paint-stop-charcoal.md','references/recipes/sunlight-screenprint.md','scripts/inspect_image.py','scripts/create_edit_input.py','scripts/compare_output.py','agents/openai.yaml','LICENSE']:
